...
#define OUTPUT 1
#define INPUT 0
//You can change the pins number according to your project
#define ringPin_Pin GPIO_PIN_4
#define ringPin_GPIO_Port GPIOC
#define sleepPin_Pin GPIO_PIN_3
...
public:
   ...
   //TODO Homemade non-static functions
         uint8_t MRT_Iridium_setup(uint8_t timeout, uint8_t i2c_bus, void (*iridium_print)(char*));
      ...
      //TODO print function passed through setup
         void (*print)(char*);
         char* IMEI;
