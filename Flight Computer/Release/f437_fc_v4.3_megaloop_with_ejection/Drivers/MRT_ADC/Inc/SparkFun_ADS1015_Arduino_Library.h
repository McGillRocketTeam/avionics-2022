...
*/
#ifndef MRT_SPARKFUN_ADS1015_H_
#define MRT_SPARKFUN_ADS1015_H_
...
class ADS1015 {
  public:
	...
	uint8_t MRT_adc1015_setup(uint8_t i2c_bus, void (*adc1015_print)(char*));
	uint16_t MRT_getDifferential();
	uint16_t MRT_getSingleEnded();
