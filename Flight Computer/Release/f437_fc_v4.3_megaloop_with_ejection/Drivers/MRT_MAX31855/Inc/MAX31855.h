...
#define SSPORT 			TH_CS_GPIO_Port		// GPIO Port of Chip Select(Slave Select)
#define SSPIN  			TH_CS_Pin			// GPIO PIN of Chip Select(Slave Select)
#define MAX31855_SPI	hspi4				// SPI bus for chip
