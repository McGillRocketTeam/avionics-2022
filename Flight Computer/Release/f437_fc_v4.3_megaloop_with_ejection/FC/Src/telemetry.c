...
#include "MRT_ADS1015.h" //TODO new perssure ADC
...
void telemetry_format_propulsion(void) {
	...
	//tank_pressure = tank_pressure_buf[PROP_TANK_PRESSURE_ADC_BUF_LEN-1]; TODO original
...
void prop_poll_pressure_transducer(void) {
	...
	*/
	...
	uint16_t pressure_sensor_raw = hadc1015.getDifferential();

	//TODO filter??

	tank_pressure = pressure_sensor_raw;
}
