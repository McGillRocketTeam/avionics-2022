...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/MAX31855.d ./Core/Src/MAX31855.o ./Core/Src/ejection.d ./Core/Src/ejection.o ./Core/Src/gps.d ./Core/Src/gps.o ./Core/Src/i2c_sensors_functions.d ./Core/Src/i2c_sensors_functions.o ./Core/Src/lps22hh_reg.d ./Core/Src/lps22hh_reg.o ./Core/Src/lsm6dsl_reg.d ./Core/Src/lsm6dsl_reg.o ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/sd_card.d ./Core/Src/sd_card.o ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/sx126x.d ./Core/Src/sx126x.o ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/video_recorder.d ./Core/Src/video_recorder.o ./Core/Src/w25qxx.d ./Core/Src/w25qxx.o
