...
class SX1262 {
    public:
        ...
        */
        ...
        command_status_t readBufferUnknownLength(uint8_t *received_buf);
        command_status_t readBufferKnownLength(uint8_t offset, uint8_t size, uint8_t *received_buf);
       ...
       */
        ...
        */
        ...
        bool isBusy();
        command_status_t getCmdErrors(uint8_t error);
